		...
		2: [function(_dereq_, module, exports) {
			...
			function Neo4jD3(_selector, _options) {
				...
				function defaultDarkenColor() {
					return d3.rgb(options.colors[options.colors.length - 1])
						.darker(1);
				}
				...
				function initSimulation() {
					var simulation = d3.forceSimulation()
						...
						.force('center', d3.forceCenter(svg.node()
							.parentElement.parentElement.clientWidth / 2, svg.node()
							.parentElement.parentElement.clientHeight / 2))
						.on('tick', function() {
							tick();
						})
						.on('end', function() {
