...
CREATE TABLE  IF NOT EXISTS `data_t` (
  ...
  `char_column0` char(10) COMMENT '预留char字段0',
  `char_column1` char(10) COMMENT '预留char字段1',
  `char_column2` char(10) COMMENT '预留char字段2',
  `char_column3` char(10) COMMENT '预留char字段3',
  `char_column4` char(10) COMMENT '预留char字段4',
  `char_column5` char(10) COMMENT '预留char字段5',
  `char_column6` char(10) COMMENT '预留char字段6',
  `char_column7` char(10) COMMENT '预留char字段7',
  `char_column8` char(10) COMMENT '预留char字段8',
  `char_column9` char(10) COMMENT '预留char字段9',
  `int_column1` bigint(20) COMMENT '预留整数字段1',
  `int_column2` bigint(20) COMMENT '预留整数字段2',
  `int_column3` bigint(20) COMMENT '预留整数字段3',
